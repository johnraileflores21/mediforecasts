    ...
    return (
        <div className="h-100% w-64 bg-teal-600 text-white flex flex-col">
            <div className="p-2 ml-2 text-2xl font-bold border-b border-white flex items-center">
                <img src="" alt="Logo" className="w-10 h-10 mr-3" /> 
                MediForecast
            </div>
             <div className="p-2 ml-3 text-2xl font-bold border-b border-white flex items-center">
                <img src="/images/acc.png" alt="Back Icon" className="w-10 h-10 mr-3" /> 
                Name
            </div>
        
            <nav className="flex flex-col flex-grow p-4 mt-1 space-y-2">
